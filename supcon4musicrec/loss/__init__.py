...
Original paper: https://arxiv.org/abs/2004.11362
"""
...
class SupConLoss(nn.Module):
    ...
    def forward(self, features, labels=None, mask=None):
        ...
        mean_log_prob_pos = (mask * log_prob).sum(1) / summed_mask
        # Avoid 0 division leading to NaN error.
        if self.avoid_nan:
            try:
                assert not mean_log_prob_pos.isnan().any()
